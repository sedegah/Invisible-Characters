...
export const FAQSection = ({ title = "Frequently asked questions", faqs = defaultFAQs }: FAQSectionProps) => {
  ...
  return (
    <section className="w-full py-12 sm:py-24 px-4 sm:px-8 bg-slate-950">
      <div className="max-w-7xl mx-auto">
        <div className="grid lg:grid-cols-12 gap-8 sm:gap-16">
          <div className="lg:col-span-4">
            <h2
              className="text-2xl sm:text-3xl lg:text-[40px] leading-tight font-normal text-white tracking-tight sticky top-20 sm:top-24"
              style={{
            ...
            <div className="space-y-0">
              {faqs.map((faq, index) => (
                <div key={index} className="border-b border-slate-700 last:border-b-0">
                  ...
                  >
                    <span
                      className="text-sm sm:text-lg leading-6 sm:leading-7 text-white pr-4 sm:pr-8"
                      style={{
                        fontFamily: "var(--font-figtree), Figtree",
                      }}
                    >
                    ...
                    >
                      <Plus className="w-5 h-5 sm:w-6 sm:h-6 text-cyan-400" strokeWidth={1.5} />
                    </motion.div>
                  </button>
                  ...
                  <AnimatePresence initial={false}>
                    {openIndex === index && (
                      ...
                      >
                        <div className="pb-4 sm:pb-6 pr-4 sm:pr-12">
                          <p
                            className="text-sm sm:text-lg leading-6 text-slate-300"
                            style={{
                              fontFamily: "var(--font-figtree), Figtree",
                            }}
                          >
